...
enum Theme {
    ...
    static let customRed = UIColor(red: 230/255, green: 64/255, blue: 10/255, alpha: 1)
    ...
    static let FSCalendarStandardSelectionColor = UIColor(red: 31/255, green: 119/255, blue: 219/255, alpha: 1.0)
    static let FSCalendarStandardTodayColor = UIColor(red: 198/255, green: 51/255, blue: 42/255, alpha: 1.0)
